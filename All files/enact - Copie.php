...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($field_errors)) {
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO enact
...
<body>
    ...
    <?php else: ?>
        ...
        <div class="left-section">
          <h2> Enactus World Cup 2025</h2>
          <div class="price">$10,00 <span class="currency">DT</span> </div>
          <div class="summary"><hr>
            <p><strong>Subscription</strong></p>
            <p>🌍 Enactus World Cup 2025 <br>
                Celebrating Social Innovation. Empowering Next-Gen Leaders. <br>
                
                The Enactus World Cup is more than a competition — it's a global celebration of student innovation, social impact, and entrepreneurial action for a better world. Every year, Enactus teams from across the globe gather to showcase
                 how their projects are transforming communities and driving real change through sustainable business solutions. <br>
                
                📍 Location: ISG BIZERTE <br>
                📅 Date:  18/05/2025<br>
                🕘 Time: 11:00<br>
                
                🌟 What You’ll Experience: <br>
                🏆 Global Finals – Watch the world’s top student teams compete with purpose-driven entrepreneurial projects <br>
                🌐 Networking & Collaboration – Connect with industry leaders, innovators, and future changemakers <br>
                💡 Innovation Showcase – Explore bold <br>
              </p>
            <hr>
          </div>
        </div>
